...
import { LibProgress, LibCurl, LibCrypt, UserClass, UserNotification, LibNavigation, ChatOnline_setter, ChatLib, LibIcon, LibImage, esp } from 'esoftplay';
...
export default function m(props: ChatLoginProps): any {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} >
      <TouchableOpacity onPress={() => LibImage.fromGallery().then((x) => {
        esp.log(x);
      })} >
